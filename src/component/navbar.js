    ...
    <div className="mynavbar">
          ...
          <div className="container-fluid">
            <div className="inline">
              <a className="navbar-brand" href="./home.html">
                <div style={{ display: "inline" }}>
                  <img src={logo} className="img-banner" alt="no img found" />
                </div>
              </a>
              <button
            ...
            >
              <ul className="navbar-nav me-0 ms-auto mb-2 mb-lg-0 ">
                ...
                <li className="nav-item">
                  <Link className="nav-link " to="/grievance">
                    Add your Grievance
                  </Link>
                </li>
      ...
      <div>
        <Routes>
          ...
          <Route path="/userlogin" extract element={<UserLogin />} />
          <Route path="/adminlogin" element={<AdminLogin />} />
          <Route path="/admindashboard" element={<AdminDashboard />} />
          <Route path="/userdashboard/:data" element={<UserDashboard />} />
